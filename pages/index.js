  ...
  return (
    <Layout>
      <div className="p-5 text-center">
        <div className="p-5">
          <h1 className='text-4xl pb-5'>Atri Hegde</h1>
          <h2 className='text-base text-opacity-90 text-slate-600 dark:text-slate-300 italic'>&quot;The bridge between dreams and reality is hard work.&quot;</h2>
          <div className='p-5'>
